...
System.out.print("Enter Choice( *integer value) : ");
...
brea: {
    // Register with name,username, password, phone 
...
Info reg = new Info(name, username, password, number, "TRANSACTION:0", FilePath);
reg.message();
...
// Reading all the lines  into oldContent
